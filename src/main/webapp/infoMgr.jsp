    ...
    <form action="/watchDog/site/manage" method="post">
        ...
        <table>
            ...
            <c:forEach items="${siteInfoList}" var="siteInfo" varStatus="status">
                ...
                <td>
                    <input type="text" class="input-readonly" name="manDescription"
                        value="${empty siteInfo.manDescription ? '未配置' : siteInfo.manDescription}">
                </td>
                <c:choose>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:choose>
                        	<c:when test="${siteInfo.probeissue && siteInfo.isInService()}">
                            <td class="td-networkcheck td-red" align="center">
                ...
                <td>
                    <input type="text" class="input-tag-id" name="tag_id" value="${siteInfo.tagId}"
                        style="width: 50px;">
                </td>
                <td>
                    <input type="text" class="input-tag-id2" name="tag_id2" value="${siteInfo.tagId2}"
                        style="width: 50px;">
                </td>
                <td>
