    ...
    <div class="container-fluid div-date-container">
        <div class="row div-split">
            <div class="col-lg-5 row div-date-fromto div-date-fromto">
                <span>发货时间:</span>
                <input class="form-control input-date" type="text" id="deliveryTimeFrom" placeholder="请选择日期">
                <span>-</span>
                <input class="form-control input-date" type="text" id="deliveryTimeTo" placeholder="请选择日期">
            </div>
            <div class="col-lg-5 row div-date-fromto">
                <span>计划调试时间:</span> 
                <select id="commissionPlanYear" class="form-control select-year">
                	<option>-年-</option>
                	<option>2019</option>
                	<option>2020</option>
                	<option>2021</option>
                ...
                <select id="commissionPlanMonth" class="form-control select-month">
                	<option>-月-</option>
                	<option>1</option>
                	<option>2</option>
                	<option>3</option>
        ...
        <div class="row div-split">
            <div class="col-lg-5 row div-date-fromto">
                <span>调试开始时间:</span> 
                <input class="form-control input-date" type="text" id="commissionStartFrom" placeholder="请选择日期">
                <span>-</span> 
                <input class="form-control input-date" type="text" id="commissionStartTo" placeholder="请选择日期">
            </div>
            <div class="col-lg-5 row div-date-fromto">
                <span>保修到期时间:</span> 
                <select id="warrantyEndFromYear" class="form-control select-year">
                	<option>-年-</option>
                	<option>2019</option>
                	<option>2020</option>
                	<option>2021</option>
                ...
                <select id="warrantyEndFromMonth"  class="form-control select-month">
                	<option>-月-</option>
                	<option>1</option>
                	<option>2</option>
                	<option>3</option>
                ...
                <span>-</span> 
                <select id="warrantyEndToYear" class="form-control select-year">
                	<option>-年-</option>
                	<option>2019</option>
                	<option>2020</option>
                	<option>2021</option>
                ...
                <select id="warrantyEndToMonth" class="form-control select-month">
                	<option>-月-</option>
                	<option>1</option>
                	<option>2</option>
                	<option>3</option>
    ...
    <table id="table" data-toggle="table" data-url="/watchDog/retail/getData" data-search="true"
        ...
        <thead>
            <tr>
                ...
                <th data-field="commissionPlanndTime" data-formatter="dateFormatter">计划调试时间</th>
